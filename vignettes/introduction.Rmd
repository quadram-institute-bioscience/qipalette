...
The `qipalette` package provides a collection of color palettes for data visualization in R. This vignette demonstrates how to use the package functions and apply the palettes to your visualizations.
...
sunset_colors <- get_palette("sunset")
sunset_colors
...
plot(1:5, 1:5, col = get_palette("ocean", 5), pch = 19, cex = 3,
     main = "Ocean Palette Demo", xlab = "X", ylab = "Y")

# Bar plot
barplot(1:5, col = get_palette("forest"), main = "Forest Palette Demo")

# Pie chart
pie(rep(1, 5), col = get_palette("sunset"), main = "Sunset Palette Demo")
```
...
The `qipalette` package provides easy-to-use color palettes that enhance the visual appeal of your plots. With functions for both base R and ggplot2 integration, it fits seamlessly into your existing visualization workflow.

Experiment with different palettes and options to find the best visual representation for your data!
